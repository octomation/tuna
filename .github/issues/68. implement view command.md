...
- If 3 models → 3 columns, each taking one-third of the width
- If 4+ models → 3 columns visible + horizontal scrolling
...
- [ ] Columns fill all available screen width (no unused space)
- [ ] Maximum 3 columns visible (1 model → 1 col, 2 → 2, 3+ → 3)
...
- [ ] Horizontal scroll when more than 3 models
- [ ] Scroll indicator shows visible range (e.g., "Showing: 1-3 of 4")
- [ ] Each column independently scrollable (vertical)
- [ ] Input query collapsible/expandable with Tab
- [ ] Column heights adjust when input is expanded
- [ ] Space/g/b keys update ratings for focused column
- [ ] Clean exit with q/Esc
- [ ] Help available with ?

### Not implemented
- [ ] Markdown responses render properly with glamour (glamour dependency not added, displays as plain text)
